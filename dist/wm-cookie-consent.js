...
`;
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", appendManageButton);
  } else {
    appendManageButton();
  }
}
function wm_loadAllowedScripts() {
  ...
  if (!consent) return;
  document.querySelectorAll('script[type="text/plain"][data-src]').forEach((el) => {
